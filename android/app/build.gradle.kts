...
android {
    namespace = "com.bor_devs.shoplist"
    compileSdk = 35
    ...
    buildTypes {
        debug {
            // Use release signing when available so debug→release updates work.
            if (keystorePropsFile.exists()) {
